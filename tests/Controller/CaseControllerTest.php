...
class CaseControllerTest extends BaseFunctionalTestCase
{
    ...
    public function testServedOrdersShowsFiftyMostRecentOrders()
    {
        ...
        self::assertEquals(50, $rows->count());
        self::assertStringContainsString($mostRecentOrder->getIssuedAt()->format('d/m/Y'), $tableBody->html());
        self::assertStringNotContainsString($oldestOrder->getIssuedAt()->format('d/m/Y') ,$tableBody->html());
    }
}
