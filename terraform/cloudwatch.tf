      ...
      "widgets": [
          {
              ...
              "properties": {
                  "metrics": [
                      [ "AWS/ApplicationELB", "RequestCount", "TargetGroup", "${aws_lb_target_group.frontend.arn_suffix}", "LoadBalancer", "${aws_lb.loadbalancer.arn_suffix}", { "stat": "Sum", "period": 86400, "label": "requests" } ]
                  ],
                  "view": "singleValue",
                  "stacked": false,
                  "region": "eu-west-1",
          ...
          },
          {
              ...
              "properties": {
                  "metrics": [
                      ...
                      [ "AWS/ApplicationELB", "RequestCount", "TargetGroup", "${aws_lb_target_group.frontend.arn_suffix}", "LoadBalancer", "${aws_lb.loadbalancer.arn_suffix}", { "stat": "Sum", "period": 300, "label": "Total Requests", "id": "r1", "color": "#2ca02c" } ],
                      ...
                      [ ".", "HTTPCode_ELB_4XX_Count", "LoadBalancer", "${aws_lb.loadbalancer.arn_suffix}", { "period": 300, "stat": "Sum", "id": "lb4", "visible": false, "label": "ALB 4xx Errors" } ],
          ...
          },
          {
              ...
              "properties": {
                  "metrics": [
                      [ "AWS/ApplicationELB", "HTTPCode_Target_4XX_Count", "TargetGroup", "${aws_lb_target_group.frontend.arn_suffix}", "LoadBalancer", "${aws_lb.loadbalancer.arn_suffix}", { "period": 86400, "stat": "Sum", "label": "4xx errors" } ]
                  ],
                  "view": "singleValue",
                  "region": "eu-west-1",
                  "title": "4xx Errors",
