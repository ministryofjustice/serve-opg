...
{
    public static function createUploadedFile(string $fileLocation, string $originalName, string $mimeType): UploadedFile
    {
        self::bootKernel();
    ...
    public static function countCsvRows(string $fileLocation, bool $excludeHeaderRow): int
    {
